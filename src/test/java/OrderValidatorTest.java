...
public class OrderValidatorTest {
    ...
    public void testUndefined() {
        ...
        assertEquals(OrderStatus.UNDEFINED, order.getOrderStatus());
    ...
    public void testGetValidatedOrders() {
        ...
        for (Order validatedOrder : validatedOrders) {
